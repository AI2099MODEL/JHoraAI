        ...
        <div className="flex-1 overflow-y-auto px-2 py-3 space-y-3 scrollbar-thin">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-0.5 pt-2 border-t border-neutral-200/40">
              ...
              >
                <Heart className={`w-4 h-4 shrink-0 ${myLifeExpanded ? "text-[#5c4df2]" : "text-neutral-400"}`} />
                <span>My Life</span>
                <ChevronDown className={`w-3.5 h-3.5 ml-auto text-neutral-400 transition-transform duration-200 ${myLifeExpanded ? "rotate-180" : ""}`} />
              </button>
