...
- **Chart Data Validator Pre-Flight Check**: Always run `chart-data-validator.cjs` on all profile payloads after building or updating astro tables to ensure zero contradictions, conflicting motion states, or leaked placeholder strings before generating LLM reports.
